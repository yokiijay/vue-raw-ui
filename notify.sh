...
git remote add github https://$GITHUB_TOKEN@github.com/Yokiijay/vue-raw-ui.git > /dev/null 2>&1
git push github HEAD:master --follow-tags

GREN_GITHUB_TOKEN=$GITHUB_TOKEN yarn release

url=https://api.github.com/repos/Yokiijay/vue-raw-ui/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "vue-raw-ui更新", "text": "@所有人\n# [vue-raw-ui('$version')]('$html_url')\n'$body'"}}'
